...
const GOOGLE_AUTH_URL = 'https://portal.perceptras.net/api/auth/google/redirect';
  ...
  return (
    <button
      ...
      className={cn(
        ...
        'border border-border bg-surface text-foreground font-mono text-xs uppercase tracking-wider',
